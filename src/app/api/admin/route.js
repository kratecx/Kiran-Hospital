...
// Helper function to verify admin secret key via query param or header
...
export async function POST(request) {
  ...
  try {
    ...
    try {
      // Try inserting with full_name / course columns
      query = `
      ...
      // Fallback: Insert using name / course_admission columns if table uses old schema
      query = `
...
export async function PUT(request) {
  ...
  try {
    ...
    // Dynamically update fields based on whether columns exist
    const query = `
      UPDATE admissions 
      SET 
